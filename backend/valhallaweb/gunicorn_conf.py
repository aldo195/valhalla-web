...
import logbook
from valhallaweb import config as valhalla_config
...
def post_fork(server, worker):
    ...
    logging_rotating_file_handler = logging.handlers.RotatingFileHandler(
        valhalla_config.LOG_FILE_PATH.replace('.log', f'.{worker.pid}.flask.log'),
    ...
    logger_setup = logbook.NestedSetup([
        ...
        logbook.RotatingFileHandler(valhalla_config.LOG_FILE_PATH.replace('.log', f'.{worker.pid}.log'),
